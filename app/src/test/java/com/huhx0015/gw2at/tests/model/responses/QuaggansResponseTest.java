...
@Config(constants = BuildConfig.class,
        ...
        sdk = 25)
public class QuaggansResponseTest {
    ...
    // CONSTANT VARIABLES
    private static final String TEST_JSON_DATA_PATH = GW2TestConstants.TEST_RESPONSES_PATH + "quaggansMockData.json";
    private static final String TEST_GET_PATH = "quaggans";
    ...
    private static final String TEST_QUAGGANS_URL = "https://static.staticwars.com/quaggans/box.jpg";
    ...
    public void testValidQuaggansResponse() {
        ...
        Observable<List<QuaggansResponse>> call = quaggansRequest.getQuaggans(GW2TestConstants.TEST_QUERY_ALL);
        call.subscribeOn(Schedulers.io())
                ...
                .subscribe(new Observer<List<QuaggansResponse>>() {
                    ...
                    public void onNext(List<QuaggansResponse> response) {
                        ...
                        assertNotNull(GW2TestResponses.TEST_VARIABLE_NULL, imageUrl);
                        assertEquals(TEST_QUAGGANS_URL, imageUrl);
                    }
